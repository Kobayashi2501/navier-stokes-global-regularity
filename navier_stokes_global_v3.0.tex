...
\textbf{Note.} The Variation of Mixed Hodge Structures (VMHS) and tropical coordinates introduced here are abstract tools from algebraic geometry. However, in our context, they function as formal descriptors of topological simplification---serving to capture barcode degenerations in a structured geometric regime.
